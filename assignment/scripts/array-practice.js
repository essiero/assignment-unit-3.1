...
let favoriteFoods = ['pad see ew', 'goat cheese', 'black raspberries', 'tacos al pastor']
...
let veryLastAnimal = animalArray[animalArray.length - 1]
  console.log('Last animal is', veryLastAnimal);
...
let dessert = 'mint chip ice cream';
